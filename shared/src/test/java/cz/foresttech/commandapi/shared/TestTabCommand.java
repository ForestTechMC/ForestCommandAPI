...
@Command(name = "cmd")
public class TestTabCommand implements CommandProcessor{
    ...
    public void argSubCmd(String sender, @Arg(name = "test") String arg1, @Arg(name = "test2", required = false) TestObject arg2) {
        System.out.println("[" + sender + "] Arg sub command with arg1: " + arg1 + " and non-required arg2: " + arg2.name());
    }

    @SubCommand(names = "required")
    public void argSubCmdReq(String sender, @Arg(name = "test") String arg1, @Arg(name = "test2") TestObject arg2) {
        System.out.println("[" + sender + "] Arg sub command with arg1: " + arg1 + " and required arg2: " + arg2.name());
    }
